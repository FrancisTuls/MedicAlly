...
const String mEnterPassword = "Enter your password";
const String mLoginHaveAccount = "Already have an account?";
const String mLoginNoAccount = "Don't have an account?";
